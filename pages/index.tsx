    ...
    <>
      <Layout>
        <Head>
          ...
          ></link>
          <title>Profile | Niraj Kashyap</title>

          <meta name="keywords" content="Niraj Kashyap @ GitHub" />
          <meta name="description" content="Niraj Kashyap @ GitHub" />
          <meta name="author" content="Niraj Kashyap" />
          <meta name="copyright" content="Niraj Kashyap" />
          <meta name="application-name" content="Profile Niraj Kashyap" />
          <meta property="og:title" content="Niraj Kashyap @ GitHub" />
          <meta property="og:description" content="Niraj Kashyap @ GitHub" />
        </Head>
        ...
        <Container>
          ...
          >
            ...
            it:
            <a href="https://docs.google.com/document/d/1UHJdtYtGHVle6BNlwBO2f40pkLE0htqf2-tLqsT3sUo">
              Download PDF
            </a>
          </iframe>
{/* 
                ...
                <div className="flex-none lg:flex">
                  <div className="flex-auto ml-3 justify-evenly py-2">
                    ...
                    <div className="flex py-4  text-sm text-gray-600">
                      <div className="flex-1 inline-flex items-center"></div>
